...
app_server <- function(input, output, session) {
  ...
  mod_modelo_programas_server("modelo_programas_1", datos = ATTprog, datos_demograficos = resultados_modelos_prog, detalle = "Programa", resumen_jeq = valor_agregado_jearquico_IES)
